...
exports.sendFriendRequest = async (req, res) => {
    ...
    try {
        ...
        await db.execute(
            'INSERT INTO friendships (requester_id, receiver_id, status, created_at, updated_at) VALUES (?, ?, ?, NOW(), NOW())',
        ...
        await db.execute('INSERT INTO conversation_participants (conversation_id, user_id, joined_at) VALUES (?, ?, NOW())', [conversationId, requesterId]);
        await db.execute('INSERT INTO conversation_participants (conversation_id, user_id, joined_at) VALUES (?, ?, NOW())', [conversationId, receiverId]);
